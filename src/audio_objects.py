...
stop1 = Stop(0.8, 1, 0.0001, 0.07, partList, 1, [1, 0.004, 0.012, 0, 0.0045, 0.0024, 0, 0, 0], [0.2, 0.3, 0.1, 0.2, 0.1, 0.07, 0.08, 0.08], [0.2, 0.3, 0.1, 0.2, 0.1, 0.07, 0.08, 0.08], ([0.9]*8), [0.2, 0.3, 0.1, 0.2, 0.1, 0.07, 0.08, 0.08], 0.001, 0.146, 0.5, 0.1, 3, 0, 0, 0.02, 0, 0.0, 0.0, 0, openSumT, openSumR, 0.3)
